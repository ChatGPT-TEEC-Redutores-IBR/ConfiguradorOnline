...
$query->execute([$qucm, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $qucm, $plbu, $qucm, $plde,
                 $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu]);
