...
$stmt->execute([$qucm, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $plgu]);

while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    $valor = htmlspecialchars($row["PLFU"]);
    $descricao = htmlspecialchars($row["PLFU"]);
