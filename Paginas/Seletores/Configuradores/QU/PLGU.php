...
$stmt->execute([$qucm, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu, $qucm, $plbu, $qucm, $plde, $plbu]);

while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
    $valor = htmlspecialchars($row["PLGU"]);
    $descricao = htmlspecialchars($row["PLGU"]);
