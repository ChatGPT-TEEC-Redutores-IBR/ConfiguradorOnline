...
$sql = "INSERT INTO _USR_CONF_SITE_HISTORICO_COTACAO (DS_EMAIL, DS_REFERENCIA, CD_OPORTUNIDADE, DS_LINK, DT_DATA)
    ...
    log_event('RegistrarCotacao: ' . $e->getMessage());
    http_response_code(500);
    echo json_encode(['erro' => 'Erro ao registrar cotacao']);
}
?>